...
const Header = () => {
    ...
    <header>
        ...
        <HContainer gap="24px" centered={true}>
          <div id="header-menu-square">
          ...
          <HContainer gap="16px" centered={true}>
            ...
            <HContainer direction="column">
                <p style={{color: "#C1C4CB", fontWeight: 300, fontSize: 13}}>
                    Document Name
                </p>
                <p style={{color: "#fff", fontWeight: 400, fontSize: 15}}>
                    welcome.md
                </p>
            </HContainer>
          </HContainer>
